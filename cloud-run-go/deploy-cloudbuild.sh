...
OAUTH_CLIENT_ID="${OAUTH_CLIENT_ID:-493569650708-k1m3knr8em27foe6h13fotfknhuqpsss.apps.googleusercontent.com}"
OAUTH_CLIENT_SECRET="${OAUTH_CLIENT_SECRET:-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}"
